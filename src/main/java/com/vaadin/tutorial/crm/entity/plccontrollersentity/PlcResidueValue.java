...
/**
 * Класс модель описывающий таблицу plccontrollervalueresidue, которая содержит значения переменных ПЛК выпарка
 */
@Entity(name = "plccontrollervalueresidue")
@Getter
@Setter
public class PlcResidueValue implements Serializable {
    @Id
