...
public class ReportLayout extends AppLayout {
    ...
    public ReportLayout(SecurityConfiguration securityConfiguration) {
    ...
    private void createDrawer() {
        ...
        RouterLink powerValue = new RouterLink("Отчет по показаниям", PowerResourceReport.class);
        powerValue.setHighlightCondition(HighlightConditions.sameLocation());
        Icon icon2 = new Icon(VaadinIcon.PIN_POST);
        hMenu2.add(icon2, powerValue);
