...
/**
 * Класс содержащий реализацию визуальных элементов и логики для plc контроллера розлива
 * в реальном времени
 */
...
public class PlcValueBottling extends VerticalLayout{
    ...
    @Autowired
    public PlcValueBottling(PlcControllersService plcControllersService, SignalListService signalListService, SignalGroupsService signalGroupsService) {
    ...
    public Component initController() {
        ...
        if (PLCConnect.contrConnectedBottling) {
    ...
    protected void onAttach(AttachEvent attachEvent) {
        ...
        updateFields = new UpdateValueController(attachEvent.getUI(), sigFieldList, controllerSignalList, PLCConnect.clientForStatusBottling);
        updateFields.start();
    }
