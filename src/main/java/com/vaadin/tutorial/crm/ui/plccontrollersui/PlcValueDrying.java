...
/**
 * Класс содержащий реализацию визуальных элементов и логики для plc контроллера сушки
 * в реальном времени
 */
@Route(value = "plcdrying", layout = PlcLayout.class)
@PageTitle("Визуализация значений контроллера Жомосушки и гранулятора | Система управления производством")
@CssImport("./styles/shared-styles.css")
@CssImport(value = "./styles/vaadin-text-field-styles.css", themeFor = "vaadin-text-field")
public class PlcValueDrying extends VerticalLayout{
    ...
    @Autowired
    public PlcValueDrying(PlcControllersService plcControllersService, SignalListService signalListService, SignalGroupsService signalGroupsService) {
    ...
    protected void onAttach(AttachEvent attachEvent) {
        ...
        updateFields = new UpdateValueController(attachEvent.getUI(), sigFieldList, controllerSignalList, PLCConnect.clientForStatusDrying);
        updateFields.start();
    }
